...
<div class="w3-col m7">
      ...
      <div class="w3-card-2 w3-round w3-white">
        <div class="w3-container w3-padding form-news">
          ...
          <div class="form-publicar">
            <form method="POST" action="{{ route('noticia.novo.freelancer') }}" enctype="multipart/form-data">
              {{ csrf_field() }}
              <div class="row">
                <div class="col-md-12">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="w3-input w3-border" name="conteudo" id="" cols="20" rows="5" placeholder="Digite a descrição" required></textarea>
                  </div>
                </div>
              </div>
  ...
  <div class="w3-container w3-card-2 w3-white w3-round w3-margin"><br>
    ...
    <h4>{{ $noticia->titulo }} <span class="opt-post">[<a href="/freelancer/noticia/editar/{{ $noticia->id }}">Editar</a>][<a href="/freelancer/noticia/excluir/{{ $noticia->id }}">Excluir</a>]</span></h4><br>
    <hr class="w3-clear">
    <p>{{ $noticia->conteudo }}</p>
    <div class="w3-row-padding" style="margin:0 -16px">
      <div class="w3-half">
        <img src="{{ asset('storage')  . '/freelancers/posts/' . Auth::user()->id . '/' . $noticia->imagem  }}" style="width:100%" alt="Imagem do Post" class="w3-margin-bottom">
      </div>
    </div>
  </div>
  @endforeach
