    ...
    <div class="w3-col m12">
      <div class="w3-card-2 w3-round w3-white">
        <div class="w3-container w3-padding">
          <h3 class="w3-opacity">Avaliar {{ $empresaAvaliada->nome }}</h3>
          ...
          @endif
          <hr>
          <form method="POST" action="/empresa/avaliar-produtora">
            {{ csrf_field() }}
            <input type="hidden" value="{{ $empresaAvaliada->id }}" name="idEmpresa">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="w3-input w3-border" name="descritiva" cols="20" rows="5" placeholder="Você recomendaria este produtora? (opcional)" style="max-width: 100%; min-width: 100%;"></textarea>
                </div>
              </div>
            </div>
            <hr>
