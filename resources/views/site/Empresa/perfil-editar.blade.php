    ...
    <div class="w3-col m12">
      <div class="w3-card-2 w3-round w3-white">
        <div class="w3-container w3-padding">
          ...
          <form method="POST" action="/empresa/editar-perfil/informacoes-pessoais" enctype="multipart/form-data">
            {{ csrf_field() }}
            <input type="hidden" name="endereco" value="{{ $empresa->endereco_id }}">
