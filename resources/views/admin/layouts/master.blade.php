...
<head>
  ...
  <title>SysGAP - Sistema gerenciador de agências, produtoras e freelancers</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
  {{-- Icone da página --}}
  <link rel="icon" type="imagem/png" href="/admin-assets/dist/img/icon-page-admin.png" />
  <!-- Bootstrap 3.3.6 -->
