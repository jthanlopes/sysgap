            ...
            <div class="form-group{{ $errors->has('destino') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <select class="form-control" id="destino" name="destino" required>
                  <option value="Empresas" @if($item->destino == "Empresas") {{ "selected" }} @endif>Empresas</option>
                  <option value="Freelancers" @if($item->destino == "Freelancers") {{ "selected" }} @endif>Freelancers</option>
                  <option value="Ambos" @if($item->destino == "Ambos") {{ "selected" }} @endif>Ambos</option>
                </select>
