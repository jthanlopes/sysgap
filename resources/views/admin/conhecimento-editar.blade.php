            ...
            <div class="col-md-8 col-md-offset-1">
                <form class="form-horizontal" role="form" method="POST" action="{{ route('conhecimento.editar') }}">
                    ...
                    <div class="form-group{{ $errors->has('titulo') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-10">
                            <input id="titulo" type="text" class="form-control" name="titulo" value="{{ $conhecimento->titulo }}" placeholder="Digite o título" required autofocus="">
                        </div>
                    </div>
                    ...
                    <div class="form-group{{ $errors->has('descricao') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-10">
                            <input id="descricao" type="text" class="form-control" name="descricao" value="{{ $conhecimento->descricao }}" placeholder="Digite a descrição" required>
                    ...
                    <div class="form-group{{ $errors->has('nivel') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-10">
                            <input id="nivel" type="text" class="form-control" name="nivel" value="{{ $conhecimento->nivel}}" placeholder="Digite o nível" required>
                            @if ($errors->has('nivel'))
                            <span class="help-block">
