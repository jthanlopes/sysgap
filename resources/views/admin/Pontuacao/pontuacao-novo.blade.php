...
<li class="active treeview">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Cadastro de itens de pontuação</h1>
      <hr>
      <ol class="breadcrumb">
      ...
      <div class="row">
        <div class="col-md-8 col-md-offset-1">
          <form class="form-horizontal" role="form" method="POST" action="{{ route('pontuacao.cadastrar') }}">
            {{ csrf_field() }}
            <div class="form-group{{ $errors->has('descricao') ? ' has-error' : '' }}">
              <label for="descricao" class="col-sm-2 control-label">Descrição</label>
              <div class="col-sm-10">
                <input id="descricao" type="text" class="form-control" name="descricao" placeholder="Digite a descrição" required autofocus="">
              </div>
            </div>
            <div class="form-group{{ $errors->has('valor') ? ' has-error' : '' }}">
              <label for="valor" class="col-sm-2 control-label">Valor</label>
              <div class="col-sm-10">
                <input id="valor" type="number" class="form-control" name="valor" min="10" placeholder="Digite o valor" required autofocus="">
              </div>
            </div>
