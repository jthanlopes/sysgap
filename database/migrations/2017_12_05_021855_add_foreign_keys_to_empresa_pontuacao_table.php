...
class AddForeignKeysToEmpresaPontuacaoTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('empresa_pontuacao', function(Blueprint $table)
        {
          $table->foreign('pontuacao_id', 'fk_pontua_pontua')->references('id')->on('pontuacoes')->onUpdate('NO ACTION')->onDelete('NO ACTION');
